package poloniex.data.map.poloniex;

import poloniex.data.model.poloniex.PoloniexOrderResult;
import poloniex.data.model.poloniex.PoloniexActiveLoanTypes;
import poloniex.data.model.poloniex.PoloniexChartData;
import poloniex.data.model.poloniex.PoloniexCompleteBalance;
import poloniex.data.model.poloniex.PoloniexFeeInfo;
import poloniex.data.model.poloniex.PoloniexLendingHistory;
import poloniex.data.model.poloniex.PoloniexLendingResult;
import poloniex.data.model.poloniex.PoloniexLoanOffer;
import poloniex.data.model.poloniex.PoloniexOpenOrder;
import poloniex.data.model.poloniex.PoloniexTicker;
import poloniex.data.model.poloniex.PoloniexTradeHistory;
